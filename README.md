...
Early stage. Right now this repo is just the backend skeleton (a bare Go HTTP server) — no editor, no canvas, no data-structure primitives yet. Treat this README as a statement of intent/roadmap rather than a description of finished features.
